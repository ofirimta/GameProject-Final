...
public:
    ...
    Player(const Point& point, const char(&the_keys)[NUM_KEYS + 1], Screen& theScreen, char character, Bomb& bomb_ref, int& current_room, Door* current_room_door, Switch* switch_obj);
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    void draw();
    ///////////////////////////////////////////////////////////
    void move();
    ...
    void setSwitch(Switch* new_switch)
    {
        pSwitch = new_switch;
	}
};
